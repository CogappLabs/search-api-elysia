...
```bash
curl "http://localhost:3000/collections/search?q=&histogram=%7B%22population%22%3A1000%7D"
```
...
```bash
curl "http://localhost:3000/collections/search?q=&filters=%7B%22country%22%3A%22Scotland%22%7D&histogram=%7B%22population%22%3A5000%7D"
```
